                ...
                success: function (data) {
                    ...
                    if (samochody.length > 0) {
                        ...
                        samochody.forEach(function (samochod) {
                            ...
                            // Dopasowanie zdjęcia do modelu samochodu
                           sugestieHtml += `
                                <div class="suggestion" data-suggestion="${samochod.marka} ${samochod.model}">
                                    <table>
                                        <tr>
            ...
            success: function(response) {
                ...
                if(wybranySamochod.error){
                    ...
                    if(wylosowanySamochod.model == wybranySamochod.model){
                        $(".win").html(`
                            <div class="win-content">
                                ...
                                <div class="kontener">
                                    ...
                                    <button id="grajDalej">Graj dalej</button>
                                </div>
                            </div>
                        `).css("display", "block");
                        ...
                        //przycisk graj dalej w przypadku wygranej
                        document.getElementById('grajDalej').addEventListener('click', function() {
                        ...
                        console.log("Wylosowane napędy:", pierwszyNapedWylosowany, drugiNapedWylosowany);
                        console.log("Wybrane napędy:", pierwszyNapedWybrany, drugiNapedWybrany);
                        
                        if (
                            (pierwszyNapedWylosowany === pierwszyNapedWybrany && drugiNapedWylosowany === drugiNapedWybrany)
                        ) {
                            console.log("NAPĘDY zgadzają się, kolor tła: olivedrab");
                            ...
                            console.log("NAPĘDY częściowo zgadzają się, kolor tła: goldenrod");
                            ...
                            console.log("NAPĘDY nie zgadzają się, kolor tła: darkred");
                        ...
                        console.log("Wylosowane nadwozia:", pierwszeNadwozieWylosowane, drugieNadwozieWylosowane, trzecieNadwozieWylosowane);
                        console.log("Wybrane nadwozia:", pierwszeNadwozieWybrane, drugieNadwozieWybrane, trzecieNadwozieWybrane);
                        ...
                        if (
                            ...
                            console.log("NADWOZIA zgadzają się, kolor tła: olivedrab");
                            ...
                            console.log("NADWOZIA częściowo zgadzają się, kolor tła: goldenrod");
                        ...
                        console.log("Wylosowane skrzynie:", pierwszaSkrzyniaWylosowana, drugaSkrzyniaWylosowana);
                        console.log("Wybrane skrzynie:", pierwszaSkrzyniaWybrana, drugaSkrzyniaWybrana);
